...
import ru.andryss.lavka.repository.IntervalRepository;
import ru.andryss.lavka.util.DateTimeParser;
...
public class IntervalMapperImpl implements IntervalMapper {
    ...
    @Autowired
    public IntervalMapperImpl(IntervalRepository intervalRepository, DateTimeParser dateTimeParser) {
